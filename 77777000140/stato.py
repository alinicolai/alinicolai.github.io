...
class Stabilogram():
    ...
    def from_array(self, array, center = True, original_frequency = None, resample = True, resample_frequency = 25, filter_ = True, filter_lower_bound=0, filter_upper_bound=10, filter_order = 4 ):
        ...
        if filter_ :
            self.filter_(lower_bound=filter_lower_bound, upper_bound=filter_upper_bound, order= filter_order, frequency=original_frequency)
    ...
    def filter_(self, frequency, lower_bound=0, upper_bound=10, order = 4) -> None:
        """
