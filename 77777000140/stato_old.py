...
class Stabilogram():
    ...
    def from_array(self, array, center = True, original_frequency = None, time = None, resample = True, resample_frequency = 25, filter_ = True, filter_lower_bound=0, filter_upper_bound=10, filter_order = 4, regular_frequency=False):
        """
        ...
        if regular_frequency:
            self.original_frequency = int(1/(time[1] - time[0]))
